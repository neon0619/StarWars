...
let HRToastActivityOpacity : CGFloat   = 0.0
let HRToastOpacity        : CGFloat   = 0.8  // Replace HRToastActivityOpacity with HRToastOpacity to have background on UIActivityView
...
extension UIView {
    ...
    */
    ...
    func makeToastActivityBlack() {
        self.makeToastActivityBlack(position: HRToastActivityPositionDefault)
    }
    ...
    func makeToastActivity(position pos: AnyObject, message msg: String = "") {
        ...
        activityView.backgroundColor = UIColor.clearColor().colorWithAlphaComponent(HRToastActivityOpacity)
    ...
    func makeToastActivityBlack(position pos: AnyObject, message msg: String = "") {
        let existingActivityView: UIView? = objc_getAssociatedObject(self, &HRToastActivityView) as? UIView
        if existingActivityView != nil { return }
    ...
    */
    ...
    func centerPointForPosition(position: AnyObject, toast: UIView) -> CGPoint {
        ...
        print("Warning: Invalid position for toast.", terminator: "")
